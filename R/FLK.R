###This script is downloaded from https://qgsp.jouy.inra.fr/index.php?option=com_content&view=article&id=50&Itemid=55
###All of the code is written by M. Bonhomme,C. Chevalet, B. Servin(contact author)S. Boitard, 
#######J. Abdallah, S. Blott, and M. SanCristobal

## SPF Downloaded it on 1 March 2018.
