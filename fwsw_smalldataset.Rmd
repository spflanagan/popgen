...
```{r FLPBpvals}
```
All of the added migration edges improve the fit. But which one is important?

#### Evaluating migration edges

We can use the three- and four-population tests to evaluate these admixture events.
