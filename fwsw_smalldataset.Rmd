...
swsw.tx<-read.delim("stacks/p4.fst_TXCB-TXCC.tsv")
swsw.al<-read.delim("stacks/p4.fst_ALST-FLSG.tsv")
swsw.fl<-read.delim("stacks/p4.fst_FLCC-FLHB.tsv")
```
```{r SWSWneighbors}
```
...
```
```{r plotAFS, echo=FALS,eval=FALSE}
```
