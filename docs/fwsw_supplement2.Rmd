...
kable(table(snp_pc$PC),booktabs=TRUE,
      col.names=c("PC1","PC2","PC3","PC4"),
      row.names=c("Number of outliers"))
```
...
kable(put_genes[,c(1,2,4,5,6)],booktabs=TRUE,longtable=TRUE,
      fig.cap="Table of putative freshwater adaptation genes and their gene ID name in the Gulf pipefish genome.") %>%
