...
landscape(kable(perm_summ,row.names = TRUE,booktabs=TRUE,
...
We did not find that the outliers in the analysis (in aggregate) were found in any one genomic region at a higher frequency than the non-outlier loci (Table \@ref(tab:summarizeAnnotations), Fisher's exact test, odds ratio $=$ `r ft$statistic`, $p=$ `r ft$p.value`).
