...
kable(paramsMeanings,"latex",booktabs=TRUE,
...
```{r saveBest1}
outTable[1,colnames(outTable)%in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]
...
```{r dadiPlots1,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
outTable[2,]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]


bestModels[2,]<-c("FLFW","ALFW",Model=best_mod)
```

```{r dadiPlots2,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
```{r saveBest3}
outTable[3,colnames(outTable)%in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]

bestModels[3,]<-c("FLFW","ALST",Model=best_mod)
```

```{r dadiPlots3,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
outTable[4,colnames(outTable) %in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]


bestModels[4,]<-c("FLFW","LAFW",Model=best_mod)
```

```{r dadiPlots4,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
outTable[5,colnames(outTable) %in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]

bestModels[5,]<-c("FLFW","TXFW",Model=best_mod)
```
```{r dadiPlots5,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
outTable[6,colnames(outTable) %in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]

bestModels[6,]<-c("FLFW","TXCC",Model=best_mod)
```
```{r dadiPlots6,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
outTable[7,colnames(outTable) %in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]

bestModels[7,]<-c("FLCC","ALFW",Model=best_mod)
```
```{r dadiPlots7,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
multiname<-paste0("../figs/dadi/FLLG_ALFW_",best_mod,"multinom.png")
if(file.exists(multiname)){
  knitr::include_graphics(multiname)
}
...
outTable[8,colnames(outTable) %in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]


bestModels[8,]<-c("FLCC","ALST",Model=best_mod)
```
```{r dadiPlots8,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
outTable[9,colnames(outTable) %in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]

bestModels[9,]<-c("FLCC","LAFW",Model=best_mod)
```
```{r dadiPlots9,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
outTable[10,colnames(outTable) %in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]

bestModels[10,]<-c("FLCC","TXFW",Model=best_mod)
```
```{r dadiPlots10,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
outTable[11,colnames(outTable) %in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]

bestModels[11,]<-c("FLCC","TXCC",Model=best_mod)
```
```{r dadiPlots11,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
multiname<-paste0("../figs/dadi/FCC_TXCC_",best_mod,"multinom.png")
if(file.exists(multiname)){
  knitr::include_graphics(multiname)
}
```
...
outTable[12,colnames(outTable) %in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]

bestModels[12,]<-c("ALFW","ALST",Model=best_mod)
```
```{r dadiPlots12,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
outTable[13,colnames(outTable) %in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]

bestModels[13,]<-c("ALFW","LAFW",Model=best_mod)
```
```{r dadiPlots13,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
outTable[14,colnames(outTable) %in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]

bestModels[14,]<-c("ALFW","TXFW",Model=best_mod)
```
```{r dadiPlots14,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
outTable[15,colnames(outTable) %in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]

bestModels[15,]<-c("ALFW","TXCC",Model=best_mod)
```
```{r dadiPlots15,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
outTable[16,colnames(outTable) %in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]

bestModels[16,]<-c("ALST","LAFW",Model=best_mod)
```
```{r dadiPlots16,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
outTable[17,colnames(outTable) %in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]

bestModels[17,]<-c("ALST","TXFW",Model=best_mod)
```
```{r dadiPlots17,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
outTable[18,colnames(outTable) %in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]

bestModels[18,]<-c("ALST","TXCC",Model=best_mod)
```
```{r dadiPlots18,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
outTable[19,colnames(outTable) %in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]

bestModels[19,]<-c("LAFW","TXFW",Model=best_mod)
```
```{r dadiPlots19,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
outTable[20,colnames(outTable) %in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]

bestModels[20,]<-c("LAFW","TXCC",Model=best_mod)
```
```{r dadiPlots20,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
outTable[21,colnames(outTable) %in% colnames(sumTab)]<-sumTab[sumTab$Model==best_mod,colnames(sumTab) %in% colnames(outTable)]

bestModels[21,]<-c("TXFW","TXCC",Model=best_mod)
```
```{r dadiPlots21,out.width="90%",fig.cap="Summary plot of the best model's joint site frequency spectra and its residuals as compared to those from the data."}
...
```
```{r saveBestTable}
poporder<-c('TXFW_TXCC','ALST_LAFW','ALFW_ALST','FLFW_FLCC', 
            'LAFW_TXFW','ALFW_TXFW','FLFW_TXFW','ALFW_LAFW','FLFW_LAFW','FLFW_ALFW',
