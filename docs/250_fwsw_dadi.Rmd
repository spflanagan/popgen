...
```{r fllgBestMods}
flcc_fllg_sc2mg<-do.call(rbind,extract_dadi_params(fllg_flcc[[1]][fllg_flcc[[1]]$Model=="SC2mG",]))
flcc_fllg_im2mg<-do.call(rbind,extract_dadi_params(fllg_flcc[[1]][fllg_flcc[[1]]$Model=="IM2mG",]))
```
