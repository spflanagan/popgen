...
plot(ur,tip.col=colors)
plot(rt,tip.col=colors)
```
...
```{r treemixMigrations, message=FALSE,fig.cap="Residuals (left) and trees of the treemix runs with migration edges. All models used the consensus tree with FLAB as root."}

par(mfrow=c(6,2))
r0<-plot_resid("treemix/migrations/fwsw_FLAB_m0","treemix/poplist")
t0<-plot_tree("treemix/migrations/fwsw_FLAB_m0",plotmig = F,plus=0.05,scale=T,mbar=F,cex = 0.75)

r1<-plot_resid("treemix/migrations/fwsw_FLAB_m1","treemix/poplist")
t1<-plot_tree("treemix/fwsw_k100bFLPBrm1",plus=0.05,scale=T,mbar=T,cex = 0.75)

r2<-plot_resid("treemix/migrations/fwsw_FLAB_m2","treemix/poplist")
t2<-plot_tree("treemix/fwsw_k100bFLPBrm2",plus=0.05,scale=T,mbar=F,cex = 0.75)

r3<-plot_resid("treemix/migrations/fwsw_FLAB_m3","treemix/poplist")
t3<-plot_tree("treemix/fwsw_k100bFLPBrm1",plus=0.05,scale=T,mbar=F,cex = 0.75)

r4<-plot_resid("treemix/migrations/fwsw_FLAB_m4","treemix/poplist")
t4<-plot_tree("treemix/fwsw_k100bFLPBrm4",plus=0.05,scale=T,mbar=F,cex = 0.75)

r5<-plot_resid("treemix/migrations/fwsw_FLAB_m5","treemix/poplist")
