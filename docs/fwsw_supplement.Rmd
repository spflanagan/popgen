...
We ran treemix, specifying the consensus tree with FLAB as root as the tree to use, with zero to five migration edges. To choose the optimal number of migration edges, we used the R package optM [@fitakOptMPackageOptimize2019]. Using the scree plot and the Evanno method, we determined that the best number of migration edges was 2 (Figure \@ref(fig:plotOptM)). 
