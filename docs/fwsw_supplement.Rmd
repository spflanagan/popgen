...
t1<-plot_tree("treemix/migrations/fwsw_FLAB_m1",plus=0.05,scale=T,mbar=T,cex = 0.75,mig_left=FALSE)

r2<-plot_resid("treemix/migrations/fwsw_FLAB_m2","treemix/poplist")
t2<-plot_tree("treemix/migrations/fwsw_FLAB_m2",plus=0.05,scale=T,mbar=F,cex = 0.75)

r3<-plot_resid("treemix/migrations/fwsw_FLAB_m3","treemix/poplist")
t3<-plot_tree("treemix/migrations/fwsw_FLAB_m3",plus=0.05,scale=T,mbar=F,cex = 0.75)

r4<-plot_resid("treemix/migrations/fwsw_FLAB_m4","treemix/poplist")
t4<-plot_tree("treemix/migrations/fwsw_FLAB_m4",plus=0.05,scale=T,mbar=F,cex = 0.75)

r5<-plot_resid("treemix/migrations/fwsw_FLAB_m5","treemix/poplist")
t5<-plot_tree("treemix/migrations/fwsw_FLAB_m5",plus=0.05,scale=T,mbar=F,cex = 0.75)
