...
```{r BayenvMatricesNoFL,out.width='90%',out.height='50%',fig.cap="Heatmap plots of each of the ten replicate Bayenv covariance matrices. Darker colors represent higher covariances. Populations are in the order: ALFW, ALST, LAFW, TXCC, TXFW. A randomly-chosen one of these matrices (matrix number 9) was chosen for the remaining analyses."}
...
axis(2,las=1)
mtext(expression(italic("X")^"T"~italic("X")),2,line=2,cex=2)
...
axis(2,las=1)
mtext("log(Salinity BF)",2,line=2,cex=2)
...
legend("top",c(expression(italic("X")^T~italic("X")),"Salinity BF"),
       ...
       pch=c(3,2),bty='n',ncol=2,pt.lwd=ptlwd)
dev.off()
```
