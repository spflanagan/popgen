...
kable(outdat[,c("ID","Chrom","BP","REF","ALT","region","abbr","SSCID","analysis")],
      ...
      caption="Outliers on LG6 that were shared among Stacks Texas, Alabama, and Louisiana freshwater-saltwater pairwise AMOVA-corrected Fst analyses and also outliers in the salinity-association analysis from Bayenv2.")%>%
