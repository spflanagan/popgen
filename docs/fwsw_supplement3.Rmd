...
This supplement focuses on providing supplementary methods and results of the analysis of dataset #2, focusing on the analysis of the outliers in pairwise freshwater-saltwater comparisons. The analysis of dataset #1 is found in supplement 1 and the analysis of demographic histories using this dataset (dataset #2) is found in supplement 2.
...
kable(outComp,"latex",booktabs=TRUE,
...
```
```{r upsetOutliers01,fig.cap="Upset plot with shared Stacks outliers identified using a cutoff of p=0.01.",fig.height=7.5,fig.width=8,dpi=300}
...
```{r BayenvMatricesNoFL,out.width='90%',out.height='50%',fig.cap="Heatmap plots of each of the ten replicate Bayenv covariance matrices. Darker colors represent higher covariances. Populations are in the order: ALFW, ALST, LAFW, TXCC, TXFW"}
