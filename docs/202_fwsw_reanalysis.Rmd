...
```{r treemixBootstrapM2s,fig.width=8,fig.height=9,fig.cap="Plot of the tree with no migration edge, the tree with 2 migration edges that has been analyzed, and all of the bootstrap replicates with two migration edges."}
...
bayenv_dat$locus<-as.factor(as.numeric(gsub("SNPFILES\\/(\\d+)","\\1",bayenv_dat$locus)))
