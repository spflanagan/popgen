...
col_vector<-c(TXSP=grp7colors[1],TXCC=grp7colors[1],TXFW="#2166ac",TXCB=grp7colors[1],
              ...
              FLSG=grp7colors[4],FLKB=grp7colors[4],FLFD=grp7colors[4],
              FLSI=grp7colors[4],FLAB=grp7colors[5],
...
legend("top",
       ...
       #pch=c(4,5,0,3,2),
       pch=pchs[c("perm","stacks","pc")],pt.lwd =ptsize,pt.cex=2,cex=1,
       bty='n',ncol=3)
dev.off()
```
