...
col_vector<-c('#762a83',"#2166ac",'#762a83','#762a83',"#2166ac",'#af8dc3',"#2166ac",'#e7d4e8','#e7d4e8','#e7d4e8','#e7d4e8','#7fbf7b','#1b7837','#1b7837','#1b7837',"#2166ac")
...
write.table(pap,"pca_pcadapt.txt",header=TRUE)
#plot
...
pseq<-1:npop
m<-matrix(c(rep(1,16),rep(2,4),
            3:18,rep(2,4),
            19:34,rep(2,4),
            rep(35,8),rep(36,8),rep(2,4)),
          nrow=4,ncol=npop+4,byrow = T)
#jpeg("NewPopStructure.jpeg",res=300,height=8,width=10,units="in")
#set the layout
layout(mat=m,heights=c(6,1,1,6))
#MAP
#open an empty plot window with coordinates
par(oma=c(1.5,3.5,1,1),mar=c(0,0,0,0),xpd=NA)
plot(1:10,ty="n",axes=FALSE,xlab="",ylab="",xpd=TRUE)
#specify the position of the image through bottom-left and top-right coords
rasterImage(img,0,0,12,10,xpd=TRUE)

#PopTree
par(mar=c(0,0,0,1))
plot.phylo(pt.subtree,tip.color = pt.colors,cex=5,
           edge.color = clcolr,edge.width = 2,label.offset = 0.0015)
