...
```{r ManhattanPCadapt, fig.cap="Manhattan plot of the q-values from the PCAdapt outlier analysis with the subsetted dataset and 4 PC axes retained in the analysis."}
plot_dat<-fst.plot(fw_SNPinfo,scaffs.to.plot = lgs,fst.name = "pcadaptQ",
                   chrom.name = "Chrom",bp.name = "Pos",axis.size = 0,pch=19)
```
