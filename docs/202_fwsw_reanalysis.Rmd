...
```{r}
alal<-read.delim("stacks/populations_subset75/batch_2.fst_ALFW-ALST.tsv")
alla<-read.delim("stacks/populations_subset75/batch_2.fst_ALST-LAFW.tsv")
txtx<-read.delim("stacks/populations_subset75/batch_2.fst_TXCC-TXFW.tsv")
flfl<-read.delim("stacks/populations_subset75/batch_2.fst_FLCC-FLFW.tsv")
```
