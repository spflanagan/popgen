...
We ran Treemix assuming the FLAB was the root with 100 bootstrap replicates. We can compare the residuals, trees, and migration edges, with the root-free, no-migration tree included for comparison. 
