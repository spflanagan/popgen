...
par(mfrow=c(7,11),mar=c(2,3,1,1),oma=c(1.5,1.5,1,1))
t0<-plot_resid("treemix/fwsw_k100b",  "treemix/poplist")
for(i in 1:10){ t0<-plot_resid(paste0("treemix/fwsw_k100b_",i),  "treemix/poplist") }
r0<-plot_resid("treemix/fwsw_k100bFLPBr",  "treemix/poplist")
for(i in 1:10){ r0<-plot_resid(paste0("treemix/fwsw_k100bFLPBr_",i),  "treemix/poplist") }
r1<-plot_resid("treemix/fwsw_k100bFLPBrm1","treemix/poplist")
for(i in 1:10){ r1<-plot_resid(paste0("treemix/fwsw_k100bFLPBrm1_",i),  "treemix/poplist") }
r2<-plot_resid("treemix/fwsw_k100bFLPBrm2","treemix/poplist")
for(i in 1:10){ r2<-plot_resid(paste0("treemix/fwsw_k100bFLPBrm2_",i),  "treemix/poplist") }
r3<-plot_resid("treemix/fwsw_k100bFLPBrm3","treemix/poplist")
for(i in 1:10){ r3<-plot_resid(paste0("treemix/fwsw_k100bFLPBrm3_",i),  "treemix/poplist") }
r4<-plot_resid("treemix/fwsw_k100bFLPBrm4","treemix/poplist")
for(i in 1:10){ r4<-plot_resid(paste0("treemix/fwsw_k100bFLPBrm4_",i),  "treemix/poplist") }
r5<-plot_resid("treemix/fwsw_k100bFLPBrm5","treemix/poplist")
for(i in 1:10){ r5<-plot_resid(paste0("treemix/fwsw_k100bFLPBrm5_",i),  "treemix/poplist") }
#dev.off()
```
...
par(mfrow=c(7,11),mar=c(1,1,1,1),oma=c(1,1,1,1))
r0<-plot_tree("treemix/fwsw_k100b",plus=0.05,plotmig = F,scale=T,mbar=F)
for(i in 1:10){ r0<-plot_tree(paste0("treemix/fwsw_k100b_",i),plus=0.05,plotmig = F,scale=T,mbar=F) }
t0<-plot_tree("treemix/fwsw_k100bFLPBr",plotmig = F,plus=0.05,scale=T,mbar=T)
for(i in 1:10){ t0<-plot_tree(paste0("treemix/fwsw_k100bFLPBr_",i),plus=0.05,plotmig = F,scale=T,mbar=F) }
t1<-plot_tree("treemix/fwsw_k100bFLPBrm1",plus=0.05,scale=T,mbar=F)
for(i in 1:10){ t1<-plot_tree(paste0("treemix/fwsw_k100bFLPBrm1_",i),plus=0.05,plotmig = F,scale=T,mbar=F) }
t2<-plot_tree("treemix/fwsw_k100bFLPBrm2",plus=0.05,scale=T,mbar=F)
for(i in 1:10){ t2<-plot_tree(paste0("treemix/fwsw_k100bFLPBrm2_",i),plus=0.05,plotmig = F,scale=T,mbar=F) }
t3<-plot_tree("treemix/fwsw_k100bFLPBrm3",plus=0.05,scale=T,mbar=F)
for(i in 1:10){ t3<-plot_tree(paste0("treemix/fwsw_k100bFLPBrm3_",i),plus=0.05,plotmig = F,scale=T,mbar=F) }
t4<-plot_tree("treemix/fwsw_k100bFLPBrm4",plus=0.05,scale=T,mbar=F)
for(i in 1:10){ t4<-plot_tree(paste0("treemix/fwsw_k100bFLPBrm4_",i),plus=0.05,plotmig = F,scale=T,mbar=F) }
t5<-plot_tree("treemix/fwsw_k100bFLPBrm5",plus=0.05,scale=T,mbar=F)
for(i in 1:10){ t5<-plot_tree(paste0("treemix/fwsw_k100bFLPBrm5_",i),plus=0.05,plotmig = F,scale=T,mbar=F) }
#dev.off()
```
