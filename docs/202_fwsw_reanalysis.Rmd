...
```{r plotStacksOutliers2, eval=TRUE}
ptsize<-3
...
legend("top",
       ...
       #pch=c(4,5,0,3,2),
       pch=pchs[c("perm","stacks","pc")],pt.lwd =ptsize,pt.cex=2,cex=1.5,
       bty='n',ncol=3)
dev.off()
```

```{r stacksUpset, eval=TRUE}
fw_SNPinfo<-readRDS("fw_SNPinfo.RDS")
...
upset(fromList(outliers),sets=c("Texas","Alabama","Louisiana","Florida","sharedStacks"),
      ...
      sets.x.label = "# Outliers",text.scale=rep(3,6),
      sets.bar.color =upsetcols[c("Texas","Alabama","Louisiana","Florida","sharedStacks")],
      margin1scale = 0.2,matrix.dot.alpha =0,
      sets.pt.color=upsetcols[c("Texas","Alabama","Louisiana","Florida","sharedStacks")],
      keep.order = TRUE)
dev.off()
```
...
```{r makePlotBayenvNoFL, eval=TRUE}
library(scales)
...
upsetcols<-c(permutations='#e41a1c',salBF='#377eb8',pcadapt='#a65628',
        xtx='#ff7f00',sharedStacks='#f781bf',
        Alabama='#e7d4e8',Louisiana='#af8dc3',Texas='#762a83',Florida='#1b7837')
png("../figs/upsetOutliers.png",res=300,height=8,width=8.5,,units="in",pointsize = 20)
...
png("../figs/BayenvPlots.png",height=2.5,width=6.5,units="in",res=300,pointsize = 11)
figure <- multi_panel_figure(
  width = c(4, 2),
  height = c(1,1),
  unit = "inches",
