...
plot(1:nrow(sweed),sweed$Likelihood,bty="L",type = 'n',xlab="Position on Chromosome",
     ylab="SweeD Likelihood",xaxt='n',las=1)
for(i in length(lgs)){
  if(i %% 2 == 0){ this.col<-"grey" } else { this.col <- "darkgrey" }
  points(sweed$plot.pos[sweed$Chrom==lgs],sweed$Likelihood[sweed$Chrom==lgs],pch=19,
         col=this.col)
}
```
