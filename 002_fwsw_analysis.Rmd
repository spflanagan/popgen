...
Read in sweed results

```{r sweed}
sweed.files<-list.files(path="sweed",pattern="SweeD_Report.lg",full.names=TRUE)
sweed<-do.call(rbind,lapply(sweed.files[2:6],function(file){
