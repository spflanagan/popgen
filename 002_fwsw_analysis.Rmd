...
t<-plot.smooth.stats(df=dd,smooth=dd.pp.smooth,color=comp.col["deltad"],fst.name="deltad",bp.name="Pos",
...
#plot pi
p<-plot.smooth.stats(df=pi,smooth=pi..pp.smooth,color=comp.col["pi"],fst.name="Pi",chrom.name = "Chrom",bp.name="Pos",
...
#plot heterozygosity
h<-plot.smooth.stats(df=ht,smooth=ht.pp.smooth,color=comp.col["Het"],fst.name="Het",chrom.name = "Chrom",bp.name="Pos",
                  ylabel=expression(italic(H)),
                  axis=0.75,scaffold.widths=scaff.starts,pch=19,scaffs.to.plot = scaffs)
xlab.lgs(ht,lgs,lgn,"Chrom","plot.pos",adj=1, xpd=TRUE,y=-0.05,cex=0.75)
#plot Jost's D
d<-plot.smooth.stats(df=jd,smooth=jd.pp.smooth,color=comp.col["D"],fst.name="D",chrom.name = "Chr",bp.name="POS",
...
*Near divergence analyses: `r unique(put.reg[put.reg$nearby.rad != "NA","Gene"])[unique(put.reg[put.reg$nearby.rad != "NA","Gene"]) %in% unique(put.reg[put.reg$sdd.nb != "NA","Gene"]) &unique(put.reg[put.reg$nearby.rad != "NA","Gene"]) %in% unique(put.reg[put.reg$jostd.in!= "NA","Gene"])]` 
...
png("mucin.png",height=4,width=6,units="in",res=300)       
par(mfrow=c(5,3),oma=c(2,2,2,2),mar=c(2,2,2,2))
...
![](../fwsw_results/mucin.png)
![](../fwsw_results/NHE.png)
![](../fwsw_results/TAAR.png)
