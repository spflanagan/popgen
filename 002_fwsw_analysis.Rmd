...
*Genes containing shared Fst outliers: `r unique(put.reg[put.reg$fst.in != "NA",c("Gene","Chrom")])`

*Genes containing $\delta$ -divergence outliers: `r unique(put.reg[put.reg$sdd.in != "NA",c("Gene","Chrom")])`

*Genes containing Salinity-associated outliers: `r unique(put.reg[put.reg$bfs.in != "NA",c("Gene","Chrom")])`

*Genes containing Jost D outliers: `r unique(put.reg[put.reg$jostd.in !="NA",c("Gene","Chrom")])`

*Overlap: `r unique(put.reg[put.reg$fst.in != "NA","Gene"])[unique(put.reg[put.reg$fst.in != "NA","Gene"]) %in% unique(put.reg[put.reg$sdd.in != "NA","Gene"]) &unique(put.reg[put.reg$fst.in != "NA","Gene"]) %in% unique(put.reg[put.reg$bfs.in != "NA","Gene"])]`

*Divergence analyses: `r unique(put.reg[put.reg$fst.in != "NA","Gene"])[unique(put.reg[put.reg$fst.in != "NA","Gene"]) %in% unique(put.reg[put.reg$sdd.in != "NA","Gene"]) &unique(put.reg[put.reg$fst.in != "NA","Gene"]) %in% unique(put.reg[put.reg$jostd.in != "NA","Gene"])]` 
...
abline(v=mcle_mixed_svInd[1],lty=2,lwd=2,col="#abdda4",xpd=FALSE)
