#!/bin/bash
#execute this file from /Documents/Sarahs/PstI_Data/
...
#echo "running bowtie"
#cd samples/
#sh opop_align_newgenome_25Aug2014.sh 2> bowtie.out.txt
...
sh cstacks_rx_25Aug2014.sh 2> rx.cstacks.log

#rematch against the catalog
echo "re-running sstacks"
sh sstacks_rx_25Aug2014.sh 2> rx.sstacks.log

#calculate population statistics
echo "running populations on corrected data"
populations -b 1 -P ./cor_stacks/ -t 6 -M ./popmap_oRAD.txt -r 75 -k --fstats --structure --genomic
