...
```{r plot_chosen,eval=TRUE,fig.height=4,fig.width=6,fig.align='H'}
...
```{r plot_subset,fig.height=4,fig.width=6,fig.align='H'}
...
par(mfrow=c(2,1),oma=c(2,2,2,2),mar=c(2,2,2,2))
max.complikes1<-plot.complike("p4LG4_100000_2_8_sub",leg=FALSE)
max.complikes2<-plot.complike("p4LG4_100000_2_8_sub",leg=FALSE)
