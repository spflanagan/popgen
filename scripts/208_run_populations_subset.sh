...
if [ "$WL75" = true ]; then
	...
	populations -b 2 -P ./stacks -M ../fwsw_pops_map.txt -t 4 -W ./stacks/populations_subset75/pruned_snps.txt -p 1 -r 0.01 -R 0.01 --min_maf 0.001 --fstats --plink --vcf
	mv ./stacks/batch_2.fst* ./stacks/populations_subset75/all_pops_subset75
	mv ./stacks/batch_2.plink* ./stacks/populations_subset75/all_pops_subset75
	mv ./stacks/batch_2.sumstats* ./stacks/populations_subset75/all_pops_subset75
	mv ./stacks/batch_2.vcf ./stacks/populations_subset75/all_pops_subset75
	mv ./stacks/batch_2.haplotypes.tsv ./stacks/populations_subset75/all_pops_subset75
	mv ./stacks/batch_2.populations.log ./stacks/populations_subset75/all_pops_subset75
