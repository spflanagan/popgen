...
for i in range(1,6):
	...
	Optimize_Routine(fl, pts, prefix, "no_mig", no_mig, rounds, 3, fs_folded=fs_folded, reps=reps, maxiters=maxiters, folds=folds, param_labels = "nu1, nu2, T",in_upper=[30,30,10],in_lower=[1,1,0])

	# Split into two populations, with continuous symmetric migration.
	Optimize_Routine(fl, pts, prefix, "sym_mig", sym_mig, rounds, 4, fs_folded=fs_folded, reps=reps, maxiters=maxiters, folds=folds, param_labels = "nu1, nu2, m, T",in_upper=[30,30,10,10],in_lower=[1,1,0,0])

	# Split into two populations, with continuous asymmetric migration.
	Optimize_Routine(fl, pts, prefix, "asym_mig", asym_mig, rounds, 5, fs_folded=fs_folded, reps=reps, maxiters=maxiters, folds=folds, param_labels = "nu1, nu2, m12, m21, T",in_upper=[30,30,10,10,10],in_lower=[1,1,0,0,0])

	# Split into two pops, isolation with migration model
	Optimize_Routine(fl, pts, prefix, "IM", dadi.Demographics2D.IM, rounds, 6, fs_folded=fs_folded, reps=reps, maxiters=maxiters, folds=folds, param_labels = "s, nu1, nu2, T, m12, m21",in_upper=[10,20,30,30,10,10],in_lower=[0,0.1,1,1,0,0])

	# Split into two pops, growth in one pop and two epoch in another
	Optimize_Routine(fl, pts, prefix, "growth_twoep_sym", growth_twoep_no_mig, rounds, 4, fs_folded=fs_folded, reps=reps, maxiters=maxiters, folds=folds, param_labels = "nu1, nu2,T,Tc",in_upper=[30,30,10,10],in_lower=[1,1,0,0])

	# Split into two pops, growth in one pop and two epoch in another
	Optimize_Routine(fl, pts, prefix, "growth_twoep_sym", growth_twoep_sym_mig, rounds, 5, fs_folded=fs_folded, reps=reps, maxiters=maxiters, folds=folds, param_labels = "nu1, nu2,m, T,Tc",in_upper=[30,30,10,10,10],in_lower=[1,1,0,0,0])

	# Split into two pops, growth in one pop and two epoch in another
	Optimize_Routine(fl, pts, prefix, "growth_twoep_asym", growth_twoep_asym_mig, rounds, 6, fs_folded=fs_folded, reps=reps, maxiters=maxiters, folds=folds, param_labels = "nu1, nu2,m12,m21, T,Tc",in_upper=[30,30,10,10,10,10],in_lower=[1,1,0,0,0,0])
	"""
