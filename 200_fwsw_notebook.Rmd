...
upset(fromList(outliers),sets=c("xtx","salBF","permutations","pcadapt","sharedStacks"),
      ...
      matrix.color=cols[c("xtx","sal","perm","pc","stacks")])
...
This works, as long as the fig size is large enough! So now just need to trick it out with colors. This blog post will probably be helpful: https://www.r-bloggers.com/hacking-our-way-through-upsetr/
