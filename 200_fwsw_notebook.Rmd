...
I also realized that maybe I should be using the very final round/replicate from each run, and that maybe that will solve some of my issues with the dadi plots...this ended up changing some of the results (FLFW and FLCC are now "SI" model!) and we'll see what the output looks like in the end. Maybe this will be the best solution in the end. 
