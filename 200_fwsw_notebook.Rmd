...
```{r}
sub1_map<-read.delim("stacks/populations_subset75/all_pops1/batch_2.map",header=FALSE)
sub2_map<-read.delim("stacks/populations_subset75/all_pops2/batch_2.map",header=FALSE)
...
So I also need a wrapper script to run the python script. Done! And I started running it using GNU parallel, hopefully it works well. I've decided to stick with the 12103 dataset so I don't need to re-do other analyses.  What I should do is use the whitelist for the 12103 to extract SNPs for the other populations so I can do the pairwise Fst comparisons.
...
shared_stacks<-plot_dat$ID[plot_dat$stacks_AL_P < 0.05 & plot_dat$stacks_LA_P < 0.05 &
