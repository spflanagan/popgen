...
*I've discovered that somewhere along the way the fw_SNPinfo dataset has gotten shortened. So now I need to track down where that happens (probably a merge that didn't keep everything)*. I've done #1 and #2 easily, the enrichment could be tricky. I do have the list of putative salinity genes so that could work
