...
Other stuff:
- I need to run a maximum likelihood unrooted tree with the consensus in treemix to generate covariances.
- I need to re-make the summary figure with the treemix FLLG label turned into FLFW. And change the colors of the tip labels.
