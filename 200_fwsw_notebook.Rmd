...
points(plot_dat$plot.pos[plot_dat$pcadaptQ<0.05],
       plot_dat$XtX[plot_dat$pcadaptQ<0.05],
...
points(plot_dat$plot.pos[plot_dat$stacks_AL < 0.05 & plot_dat$stacks_LA < 0.05 &
       ...
       col=cols[2],cex=1,pch=5,lwd=2)
points(plot_dat$plot.pos[plot_dat$pcadaptQ<0.05],
       plot_dat$logSalBF[plot_dat$pcadaptQ<0.05],
       col=cols[3],cex=1,pch=0,lwd=2)
axis(2,las=1)
...
legend("top",c(expression("Permutation"~italic("F")["ST"]),
         ...
         "PCAdapt","BayEnv2"),lty = 1,xjust = 0.5,x.intersp = 0.5,
       col = cols,pt.bg=cols,pch=c(4,5,0,19),bty='n',lwd = 2,ncol=2)
```
